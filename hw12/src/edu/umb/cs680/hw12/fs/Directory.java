...
public class Directory extends FSElement{
    ...
    public LinkedList<FSElement> getChildren(Comparator<FSElement> comparator) {
        LinkedList<FSElement> unsortedChildren = getChildren();
        Collections.sort(unsortedChildren, comparator);
    ...
    public LinkedList<Directory> getSubDirectories(Comparator<FSElement> comparator) {
        LinkedList<Directory> unsortedChildren = getSubDirectories();
        Collections.sort(unsortedChildren, comparator);
        return unsortedChildren;
    }
    ...
    public LinkedList<File> getSubFiles(Comparator<FSElement> comparator) {
        LinkedList<File> unsortedChildren = getSubFiles();
        Collections.sort(unsortedChildren, comparator);
        return unsortedChildren;
    }
